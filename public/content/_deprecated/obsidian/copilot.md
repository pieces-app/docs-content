...
visibility: PUBLIC
status: PUBLISHED
description: The Conversational Search in the Pieces for Obsidian Plugin boosts your workflow with AI features like integrated LLMs for generating code, commenting, saving and searching snippets, using AI Quick Actions, and much more.
metaTitle: Using Conversational Search for Obsidian | Pieces Docs
metaDescription: Learn how to use Conversational Search within Obsidian to generate code, provide explanations, and enhance productivity with AI-powered assistance.
---

## Generative AI Conversations

Facing an issue or not sure how to tackle a challenge? You can [ask Conversational Search specific questions](/products/obsidian/copilot/chat) directly in Obsidian using the Copilot Chat side window.

You can ask questions that don't need context, like *“What is the basic format for a JSON object?”* or more detailed questions where Conversational Search requires context from your active note.
...
Contextual awareness lets Conversational Search help you solve problems faster by providing answers that are relevant to the issue you're facing and your notes.
...
You can also add multiple files and other items as context to your question, giving Conversational Search comprehensive information to help you troubleshoot.
...
<AccordionGroup>
  ...
  <Accordion title="Troubleshoot and Resolve Bugs Swiftly">
    Use Conversational Search in Obsidian to streamline the bug-fixing process. Its contextual understanding and suggested solutions make writing faster, keeping your project on course.
  </Accordion>
  ...
  <Accordion title="Efficient Code Refactoring">
    Optimize your vault through intelligent refactoring recommendations. The Conversational Search analyzes your note patterns, suggests structural improvements, and delivers optimizations for both performance and readability.
  </Accordion>
</AccordionGroup>
