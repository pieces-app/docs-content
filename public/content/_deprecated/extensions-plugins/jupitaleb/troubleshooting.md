...
If you're using Conversational Search chat and lose your WiFi connection or face problems with a cloud-based LLM, refreshing the chat might be necessary. This action can fix issues like the LLM seemingly "hanging" (for instance, producing a response that times out or gets stuck in an infinite loop).
