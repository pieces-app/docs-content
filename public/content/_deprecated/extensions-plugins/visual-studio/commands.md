...
Read the documentation below to learn about the shortcuts and commands in Conversational Search and Material Management system.

## Shortcut Table

Shortcuts make a number of actions related to the <a target="_blank" href="/products/extensions-plugins/visual-studio/copilot">Conversational Search</a> and <a target="_blank" href="/products/extensions-plugins/visual-studio/drive">Material Management ecosystem</a> accessible.
...
| [Open Conversational Search](/products/extensions-plugins/visual-studio/copilot)                                                 | `alt+m, c`        |
...
| **Pieces > Ask Copilot About Selection**                 | Launches Conversational Search, allowing you to ask questions or get code insights on your current selection. |
| **Pieces > Ask Copilot About Active File**               | Allows you to ask Conversational Search about the active file open in the Visual Studio editor.               |
| **Pieces > Explain Selection with Copilot**              | Explains the selection portion of code—its functionality, usage, and more.                                 |
| **Pieces > Modify Selection with Copilot**               | Allows you to ask Conversational Search to change a code selection with a query.                              |
| **Pieces > Comment Selection with Copilot**              | Uses Conversational Search to add helpful inline comments to your code selection.                             |
...
| **Pieces > Conversational Search**                              | Opens Conversational Search side panel for contextual insights and assistance.                                |
