...
<Steps>
  ...
  <Step title="Use the Pieces for Visual Studio Extension">
    Once you’ve restarted Visual Studio, the **Pieces Account, Conversational Search,** and **Pieces Drive** views will automatically open as docked tabs in your `Solution Explorer` view.
  </Step>
</Steps>
...
### Check Out Conversational Search

Click `Open Your Conversational Search` to open Conversational Search side panel. In Conversational Search, you'll find **suggested prompts**, options to set context from folders or files, and quick options to access your saved materials.
