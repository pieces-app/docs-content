...
visibility: PUBLIC
status: PUBLISHED
description: With Conversational Search in the Pieces for Visual Studio Extension, you can quickly generate comments that clearly capture your code's functionality and intent.
metaTitle: Documenting code with Conversational Search for Visual Studio
metaDescription: Automatically generate code comments inside Visual Studio with Conversational Search to improve documentation and readability.
---

## Commenting Code Selections with Conversational Search

Conversational Search **analyzes** and **comments on selected code**, generating precise, line-by-line explanations. This enhances readability and makes your code easier to understand.
...
You can also right-click a selected portion of code, hover over `Pieces`, and choose `Comment Selection with Copilot`. Conversational Search will suggest changes that contain comments on new sections.
...
That’s what makes Conversational Search’s commenting feature so powerful. Whether you’re documenting a single function or hundreds of lines of code, simply highlight the desired code, click the `Pieces` CodeLens button, select **Comment**, and let Copilot take care of the rest.