...
metaTitle: Refactoring Code with AI in Visual Studio using Conversational Search
metaDescription: Optimize and refactor your code efficiently with Conversational Search for Visual Studio, ensuring maintainability and best practices.
---
...
Once you click `Modify Selection with Copilot`, Conversational Search opens the Chat window in the Visual Studio sidebar, showing the proposed changes.
