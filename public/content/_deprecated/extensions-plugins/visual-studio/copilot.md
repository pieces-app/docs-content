...
visibility: PUBLIC
status: PUBLISHED
description: The Conversational Search in the Pieces for Visual Studio Extension boosts coding with AI features like interchangeable LLMs, code generation, and debugging, AI Quick Actions in Visual Studio, and more.
metaTitle: How to use Conversational Search for Visual Studio | Pieces Docs
metaDescription: Use Conversational Search inside Visual Studio to generate code, debug, and improve productivity with AI-powered coding assistance.
---

## Generative AI Conversations

Facing an issue or not sure how to tackle a coding challenge? You can [ask Conversational Search specific coding questions](/products/extensions-plugins/visual-studio/copilot/chat) directly in Visual Studio using Conversational Search in the `Solution Explorer`.
...
Contextual awareness enables Conversational Search to help you solve problems more quickly by providing answers that are relevant to the issue you're dealing with and your code.
...
You can also add multiple files and other items as context to your prompt, giving Conversational Search comprehensive information to assist you in troubleshooting.
...
This opens Conversational Search in the Visual Studio sidebar, adding documentation to the highlighted snippet. You can then select one of the `Insert at Cursor` or `Accept Changes` options to add the comments to your code.
...
With the Pieces for Visual Studio extension, you can easily change code to adapt to new requirements or insert quick fixes with two powerful Conversational Search commands:
...
This flexibility lets you customize Conversational Search to fit your development needs, focusing on either speed or accuracy.
...
<AccordionGroup>
  ...
  <Accordion title="Troubleshoot and Resolve Bugs Swiftly">
    Use Conversational Search in Visual Studio to speed up bug fixing. Its contextual understanding and suggested solutions make troubleshooting quicker, keeping your project on track.
  </Accordion>
  ...
  <Accordion title="Skill Enhancement">
    Conversational Search is also a learning tool. It helps you discover best practices, new paradigms, and advanced techniques in real-time.
  </Accordion>

  <Accordion title="Efficient Code Refactoring">
    Optimize your codebase with innovative refactoring suggestions. Conversational Search analyzes your code patterns, recommends structural improvements, and provides optimizations for better performance and readability.
  </Accordion>
</AccordionGroup>
