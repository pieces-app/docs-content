...
visibility: PUBLIC
status: PUBLISHED
description: With Conversational Search in the Pieces for JetBrains Plugin, you can add AI features to any JetBrains IDE, like generating code comments and accessing AI Quick Actions.
metaTitle: How to use Conversational Search with Jetbrains Plugins
metaDescription: With Conversational Search inside the Pieces for JetBrains Plugin, you can bring the power of AI into any of your JetBrains IDEs – like PyCharm, IntelliJ IDEA, RubyMine, and more.
---

## Generative AI Conversations

If you’re unsure how to implement a specific piece of functionality, stuck on a bug, or simply want a useful answer to something within your codebase, you can use Conversational Search to receive context-aware responses to help you move forward.
...
The Conversational Search lets you add specific folders or files to the conversation’s context window—like files from the codebase you’re working in—so that you always have explicit and accurate answers to pressing questions at your fingertips.
...
By analyzing your code's structure and purpose, [Conversational Search generates clear and helpful comments](/products/extensions-plugins/jetbrains/copilot/documenting-code#commenting-code-selections-with-pieces-copilot) to improve readability and facilitate maintenance.
...
This opens Conversational Search in the JetBrains sidebar, which begins adding documentation to the highlighted snippet, from which you can select the `Insert at Cursor` option to add the comments to your code.
...
This flexibility allows you to tailor Conversational Search to your specific development needs, whether speed or accuracy.
...
<AccordionGroup>
  ...
  <Accordion title="Troubleshoot and Resolve Bugs Swiftly">
    Use Conversational Search in JetBrains to streamline the bug-fixing process. Its contextual understanding and suggested solutions make troubleshooting faster, keeping your project on course.
  </Accordion>
