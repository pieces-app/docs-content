...
metaTitle: Supported LLMs in Conversational Search for JetBrains | Pieces Docs
...
To get started, open Conversational Search chat in the side-window using any of the available methods, such as opening a Copilot Chat with an option in the tool menu, using a quick action, selecting the Pieces icon from the sidebar, and other means.
...
The Conversational Search will utilize that model for all AI-related features—no restart or refresh needed.
...
<Callout type="tip">
  Using local models allows for the flexibility to work in a completely offline environment without sacrificing Conversational Search.
</Callout>