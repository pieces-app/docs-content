...
metaTitle: Documenting Code with Conversational Search in Jetbrains | Pieces Docs
metaDescription: Document code in JetBrains using Conversational Search. Fast, smart, and seamless within your IDE.
---

## Commenting Code Selections with Conversational Search

Conversational Search can analyze and **comment on any selected portion of your code,** explaining its logic line by line. This ensures your code is readable and easy for others to understand.
...
Conversational Search generates clear, contextual comments for the selected code in the Copilot chat window. Click `Insert at Cursor` to add the comments at your cursor's location. You can also click `Accept Changes` to insert the comments directly between the lines of code where you selected the code.
