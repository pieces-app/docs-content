...
* [Conversational Search:](/products/extensions-plugins/jetbrains/copilot) Users can start generative AI conversations and add files and folders as context to get the solutions they need, including out-of-IDE context with the optional Long-Term Memory Engine (LTM-2.7).
...
- [AI Quick Actions:](/products/extensions-plugins/jetbrains/copilot/chat#ai-quick-actions) Fully integrated and Pieces-powered AI Quick Actions tools are built right into your code, making it even easier to access Conversational Search explanation and documentation features.
...
Conversational Search offers [AI-assisted features](/products/extensions-plugins/jetbrains/copilot) like starting contextualized [generative AI conversations](/products/extensions-plugins/jetbrains/copilot/chat), <a target="_blank" href="/products/extensions-plugins/jetbrains/copilot/documenting-code">adding code comments</a>, and <a target="_blank" href="/products/extensions-plugins/jetbrains/troubleshooting">troubleshooting code</a>.
...
You can perform **several decisive** **actions** with Conversational Search inside of your JetBrains IDE, like starting a conversation directly inside the editor with your LLM of choice about a specific code snippet, fragment, folder, or terminal output.

The **Ask Copilot** feature is the backbone of Conversational Search experience.

Pieces recently rolled out its new **AI Quick Actions** feature—similar to VS Code’s Codelens—which allows for select quick actions powered by Conversational Search, namely `Pieces: Explain` and `Pieces: Comment`.

<Callout type="tip">
  The Quick Action tools—`Pieces: Explain` and `Pieces: Comment`—are above the function nearest to your cursor.
</Callout>

Using either AI Quick Actions triggers Conversational Search conversation window, where you can find the output from the LLM of your choice.
...
| `Ask Copilot About Selection`             | Ask Conversational Search to generate suggestions or explain the selection with a query.                                                                                                                                                                                                                       |
...
| `Explain Selection with Copilot`          | Receive an explanation for the code using your chosen LLM through Conversational Search.                                                                                                                                                                                                                       |
