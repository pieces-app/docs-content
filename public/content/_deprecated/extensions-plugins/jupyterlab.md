...
**Conversational Search** inside JupyterLab is your context-aware AI assistant, designed to help you work smarter with your notebooks.
...
<Steps>
  ...
  <Step title="Open the View">
    Click the bot icon in the top slider of the JupyterLab Extension to open Conversational Search.
  </Step>

  <Step title="Start Prompting">
    Interact with Conversational Search to get answers related to your notebook.
  </Step>
