...
visibility: PUBLIC
status: PUBLISHED
description: Intelligently debug tricky issues and correctly center that <div> with Conversational Search.
metaTitle: Debugging Code with AI in VS Code using Conversational Search
metaDescription: Use Conversational Search in VS Code for AI-driven debugging – quickly find, fix issues, and learn from intelligent AI-generated solutions.
---

## Fixing Bugs with Conversational Search

The Conversational Search in the <a target="_blank" href="https://marketplace.visualstudio.com/items?itemName=MeshIntelligentTechnologiesInc.PiecesVisualStudio">Pieces for VS Code Extension</a> offers AI-driven debugging that **simplifies finding and fixing code issues in VS Code.** This feature not only speeds up troubleshooting but also provides an opportunity to learn from the fixes suggested by the AI.
...
Conversational Search will utilize whichever LLM you have currently active and analyze the issue. Then, it will open a Copilot chat with suggestions, regenerate the code, and provide the option `Insert at Cursor` with fresh code comments.
...
Debugging with Conversational Search smoothens error resolution and provides AI-driven insights in an experience that doesn’t detract from your workflow in VS Code.
...
<Callout type="tip">
  The Conversational Search proactively identifies code issues—highlight your code, click the **Yellow Lightbulb,** and let it analyze the problem(s).
</Callout>