...
visibility: PUBLIC
status: PUBLISHED
description: With Conversational Search inside the Pieces for VS Code Extension, you can quickly generate comments that capture the functionality and intent of your code—an often overlooked aspect of high-quality documentation.
metaTitle: Documenting Code Comments with Conversational Search in VS Code
metaDescription: With Conversational Search inside the Pieces for VS Code Extension, you can quickly generate comments that capture the functionality and intent of your code.
---

## Adding Documentation with Pieces

Conversational Search can analyze and **comment on any selected portion of your code,** explaining its logic line by line to help ensure that it is not only readable but also easy to understand for others.
...
Conversational Search will generate clear, contextual comments for the selected code inside the chat window.
