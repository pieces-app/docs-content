...
visibility: PUBLIC
status: PUBLISHED
description: Modify your code to add error handling, remove outdated documentation, and much more with Conversational Search.
metaTitle: Refactoring Code with AI in VS Code using Conversational Search
...
Once you click `Modify Selection with Copilot`, Conversational Search will open the Copilot chat window in the VS Code sidebar, generating and showcasing the proposed changes.
