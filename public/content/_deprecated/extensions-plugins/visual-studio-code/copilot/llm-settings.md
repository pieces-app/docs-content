...
metaTitle: How to Switch LLMs in Conversational Search for VS Code
metaDescription: Switch between LLMs in Conversational Search for VS Code. Choose the right model depending on your task — whether you need speed, creativity, or deep context understanding.
---
...
<Steps>
  <Step title="Open the Copilot Chat View">
    Open the Copilot Chat view by clicking the **Conversational Search** icon in the sidebar.
  </Step>
