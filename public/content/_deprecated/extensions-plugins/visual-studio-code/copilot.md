...
visibility: PUBLIC
status: PUBLISHED
description: Unlock AI-generated debugging, code comments, context-adjusted prompting,  and more with Conversational Search.
metaTitle: How to Use Conversational Search in VS Code | Pieces Docs
metaDescription: Enhance VS Code with Conversational Search – generate code, add comments, debug, and use AI Quick Actions with swappable LLMs seamlessly
---

## Overview

Conversational Search within the <a target="_blank" href="https://marketplace.visualstudio.com/items?itemName=MeshIntelligentTechnologiesInc.PiecesVisualStudio">Pieces for VS Code Extension</a> integrates advanced AI capabilities into your coding workflow, like swappable LLMs for adding code comments, generating additional code, debugging, and more.

The Conversational Search allows you to generate intelligent code comments, access AI Quick Actions, and ask variable-context coding questions without leaving Visual Studio Code.

## Generative AI Conversations

Facing an issue or not sure how to tackle a coding challenge? You can [ask Conversational Search specific coding questions](/products/extensions-plugins/visual-studio-code/copilot/chat) directly in VS Code using the Copilot Chat side window.

You can ask any question that doesn’t require context, such as *“What is the basic format for a JSON object?”,* or more in-depth questions where Conversational Search needs context from your active code.
...
Contextual awareness allows Conversational Search to help you overcome obstacles faster by providing answers that are *actually* relevant to the current issue you’re facing and to your code.
...
You can also [add multiple files and other items as context](/products/extensions-plugins/visual-studio-code/copilot/chat#adding-items-to-copilot-chats) to your question, giving Conversational Search comprehensive information to help you troubleshoot.
...
This opens Conversational Search in the VS Code sidebar, where documentation is automatically generated for the highlighted snippet. You can then select `Insert at Cursor` to add the comments directly to your code.
...
With the Pieces for VS Code extension, you can enhance your workflow with two powerful Conversational Search commands:
...
This flexibility allows you to tailor Conversational Search to your specific development needs, whether it’s speed or accuracy.
...
The [Pieces MCP](/products/mcp) works inline with GitHub Copilot within VS Code, allowing you to use your favorite Pieces actions directly within your VS Code or VS Code forks.
...
<AccordionGroup>
  ...
  <Accordion title="Troubleshoot and Resolve Bugs Swiftly">
    Use Conversational Search in VS Code to streamline the bug-fixing process. Its contextual understanding and suggested solutions make troubleshooting faster, keeping your project on course.
  </Accordion>
