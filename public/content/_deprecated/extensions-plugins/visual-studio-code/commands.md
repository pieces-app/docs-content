...
There are a number of actions related to the <a target="_blank" href="/products/extensions-plugins/visual-studio-code/copilot">Conversational Search</a> and [Pieces Drive management ecosystem](/products/extensions-plugins/visual-studio-code/drive) that are accessible with shortcuts.
...
| **Conversational Search: Focus on Conversational Search View** | Launches Conversational Search in the side panel, providing contextual insights and assistance for the currently open code.                               |
| ------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
...
| **Pieces: Ask Copilot About Active File**        | Allows you to ask Conversational Search about the active file open in the VS Code Editor.                                                                 |
| **Pieces: Ask Copilot About Selection**          | Opens up a prompt for you to ask Conversational Search a specific question about a selection.                                                             |
| **Pieces: Ask Copilot About Workspace**          | Ask Conversational Search for insights about your entire workspace, including saved files and snippets.                                                   |
| **Pieces: Comment Selection with Copilot**       | Allows Conversational Search to automatically generate comments for your selected code snippet.                                                           |
| **Pieces: Explain Selection with Copilot**       | Generates a detailed explanation for the highlighted code selection using Conversational Search.                                                          |
...
| **Pieces: Modify Selection with Copilot**        | Refactor or enhance selected code by describing your intended modification. Conversational Search will implement the changes.                                 |
| **Pieces: Open Copilot**                         | Opens Conversational Search on the left-hand side of the VS Code IDE.                                                                                     |
...
| **View: Show Conversational Search**                    | Opens Conversational Search by the side of the VS Code editor.                                                                                            |
