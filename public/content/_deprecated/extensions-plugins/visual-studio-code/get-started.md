...
Clicking `Open Your Copilot` triggers Conversational Search side panel, as shown in the screenshots. In Conversational Search, you’ll find **suggested prompts**, options to set context from folders or files, and quick links to your saved materials.
