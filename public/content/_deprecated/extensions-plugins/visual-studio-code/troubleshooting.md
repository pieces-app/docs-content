...
Verify the health and status of PiecesOS and check off the boxes below if you are experiencing issues with Pieces Drive or Conversational Search within the Pieces for VS Code Extension.
