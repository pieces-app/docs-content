...
There are a number of available material management and Conversational Search-related actions available on this menu, [which you can read more about here](/products/extensions-plugins/visual-studio-code/drive/edit-update#actions-from-the-editing-view)—or view an expanded table of them below.
