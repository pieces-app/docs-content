...
When you left-click on a saved snippet in the Pieces Drive, you are presented with a tool menu filled with Pieces functionalities—some of which are related to the [Conversational Search](/products/extensions-plugins/visual-studio-code/copilot), and others which are designated [material management](/products/extensions-plugins/visual-studio-code/drive) actions.
...
Below Conversational Search actions, you can easily change a snippet’s name, description, classification, and other enriched metadata—view them in the table below.
