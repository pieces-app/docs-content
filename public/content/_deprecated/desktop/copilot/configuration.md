...
visibility: PUBLIC
status: PUBLISHED
description: Customization is key to getting the most out of any AI assistant. Read about switching between local and cloud-hosted models, adjusting the appearance of Conversational Search Chats, and more.
metaTitle: Adjusting Conversational Search | Pieces Docs
metaDescription: Learn how to enrich your Conversational Search chats by integrating context – like folders, file, and other saved materials – from your previous tasks and current projects.
---

# Adjusting Models & Appearance

Learn how to switch between local and cloud-hosted models, change the aesthetics and layout of your Conversational Search chat view, and more.
...
At the bottom left of Conversational Search view is the active model. By default, this is a cloud LLM. 
...
Conversational Search allows you to choose between cloud-hosted models and on-device models.
...
<Image src="https://storage.googleapis.com/hashnode_product_documentation_assets/desktop_app_assets/desktop_app_MAIN/new_media/Desktop%20App/screenshot_of_copilot.png" alt="Conversational Search chat view after theme customization" align="center" fullwidth="true" />