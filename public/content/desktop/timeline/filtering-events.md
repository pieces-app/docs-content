---
title: Filtering Timeline Events
path: /desktop/timeline/filtering-events
visibility: PUBLIC
status: PUBLISHED
description: Learn how to filter Pieces Timeline events by type, source, application, and favorites to find exactly what you need.
metaTitle: Filtering Timeline Events | Pieces Timeline
metaDescription: Filter Timeline events by type, source, application, and favorites to focus on specific workflow moments and activities.
---
...
<Steps>
  ...
  <Step title="Choose Applications">
