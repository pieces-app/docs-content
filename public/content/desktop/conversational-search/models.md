...
visibility: PUBLIC
status: PUBLISHED
description: Pick a model family, then choose Fast, Balanced, or Extra Thinking. Turn on Reflection Mode for deeper, self-correcting answers.
metaTitle: Choose a Model | Conversational Search
metaDescription: Switch between model families in Pieces and choose Fast, Balanced, or Extra Thinking, with optional Reflection Mode powered by the Agent Harness.
---
