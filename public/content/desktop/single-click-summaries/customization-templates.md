...
path: /desktop/single-click-summaries/customization-templates
visibility: PUBLIC
status: PUBLISHED
description: Create custom summaries with specific time ranges and topics, save reusable templates, and request new summary types.
metaTitle: Customization & Templates | Single-Click Summaries
metaDescription: Create custom summaries, save reusable templates, discover additional summary types, and request new ones in Pieces.
---
