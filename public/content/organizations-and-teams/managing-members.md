...
path: /desktop/organizations-and-teams/managing-members
visibility: PUBLIC
status: PUBLISHED
description: Learn how to manage organization members, view seat usage, handle pending invitations, and update member roles.
metaTitle: Managing Members | Pieces Docs
...
<Steps>
  <Step title="Open Pending Invites Tab">
    In the *Members* page, click the `Pending Invites` tab at the top of the page.
  </Step>

  <Step title="Review Pending Invitations">
